...
I detta repo finns koden för vårt kandidatarbete.

Vi har använt oss av dataseten HDFS och BGL från "loghub". Länk: https://github.com/logpai/loghub
Man behöver strukturera dataseten med koden som finns i "LogParsing" mappen.

För att köra koden behövs även loglizer klonas till din dator. Länk: https://github.com/logpai/loglizer
Samt ändra metoden bgl_preprocess_data i loglizer repot (https://github.com/logpai/loglizer/blob/master/loglizer/dataloader.py) till följande:
...
Man behöver även ändra till rätt "path" i koden för algoritmerna.
