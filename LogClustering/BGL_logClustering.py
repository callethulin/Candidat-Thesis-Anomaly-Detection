...
model = LogClustering(max_dist=0.01, anomaly_threshold=0.002, num_bootstrap_samples=2000)
model.fit(event_count_matrix[labels2 == 0, :]) # Use only normal samples for training
